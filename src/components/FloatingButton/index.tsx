...
import './styles.css'; // Importe os estilos do botão flutuante

const FloatingButton = () => {

    return (
        <div className="float-button">
            <a href="https://api.whatsapp.com/send?phone=5521994021137" aria-label="Botão para contato no WhatsApp">
